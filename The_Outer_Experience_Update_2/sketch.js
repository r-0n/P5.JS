...
function preload() {
  ...
  red_moon = loadImage("red moon.png");
  pink_text = loadImage("pink planet.jpg");
  green_planet = loadImage("green planet.jpg");
  gas_planet = loadImage("gas.jpg");
  redplanet = loadImage("redplanet.jpg");
  rainbowPlanet = loadImage("rainbow planet.jpg");
}
